 ...
 */
public class RealInsertBeautyTipServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (user != null) {
            ...
            if (!Utility.isEmpty(title) && !Utility.isEmpty(content) && !Utility.isEmpty(imageUrl)) {
                BeautyTip beautyTip = new BeautyTip();
                beautyTip.user = Ref.create(user);
